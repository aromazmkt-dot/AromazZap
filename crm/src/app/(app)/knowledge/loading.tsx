  ...
  return (
    <div className="space-y-4 p-1">
      <div className="flex items-start justify-between">
        <div className="space-y-1.5"><Sk w="w-32" h="h-5" /><Sk w="w-52" h="h-3.5" /></div>
      ...
      <div className="flex gap-3">
        ...
        <div className="w-36 h-10 bg-zinc-100 animate-pulse rounded-full" />
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[...Array(9)].map((_, i) => (
          <div key={i} className="bg-white border border-zinc-100 rounded-xl p-5 space-y-3 animate-pulse">
            ...
            <Sk h="h-3" /><Sk w="w-5/6" h="h-3" /><Sk w="w-2/3" h="h-3" />
            <div className="flex gap-2 pt-1">
              <Sk w="w-16" h="h-5" /><Sk w="w-20" h="h-5" />
            </div>
          </div>
        ))}
      </div>
